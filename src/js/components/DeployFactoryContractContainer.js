...
const mapStateToProps = state => ({
  ...
  loadingFactoryContract: state.contracts.loadingFactoryContract
});
...
class DeployFactoryContractContainer extends React.Component {
  ...
  render() {
    if(this.props.loadingAccounts === false) {
      return (
        <DeployFactoryContractForm 
          accounts={this.props.accounts} deployFactory={this.props.deployFactory}
          loadingFactoryContract={this.props.loadingFactoryContract}/>
      );
    } else {
      return (
        <div>
